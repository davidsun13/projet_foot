        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    err_8 = _a.sent();
                                    return [3 /*break*/, 3];
                                case 3: return [2 /*return*/, reply.status(500).send({ error: err.message })];
                            }
                        });
                    }); });
                    ...
                    web_server.patch("/matchs/:id/score", { preHandler: [requireCoach] }, function (request, reply) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    id_player = request.params.id_player;
                                    return [4 /*yield*/, repo.getdetailsplayer(Number(id_player))];
                                case 1:
                                    player = _a.sent();
                                    return [2 /*return*/, reply.send(player)];
                                case 2:
                    ...
                    web_server.get("/nexttraining", function (request, reply) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, repo.nextTraining()];
                                case 1:
                                    training = _a.sent();
                                    return [2 /*return*/, reply.send(training)];
                                case 2:
