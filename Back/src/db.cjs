...
var Repository = /** @class */ (function () {
    ...
    Repository.prototype.updateConvocationStatus = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var result;
            var id_convocation = _b.id_convocation, status = _b.status, id_player = _b.id_player;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.sql(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n    UPDATE convocation\n    SET status = ", "\n    WHERE id_convocation = ", " AND id_player = ", "\n    RETURNING id_convocation\n  "], ["\n    UPDATE convocation\n    SET status = ", "\n    WHERE id_convocation = ", " AND id_player = ", "\n    RETURNING id_convocation\n  "])), status, id_convocation, id_player)];
                    case 1:
                        result = _c.sent();
                        return [2 /*return*/, result[0]];
                }
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        player = players_2[_i];
                        return [4 /*yield*/, this.sql(templateObject_29 || (templateObject_29 = __makeTemplateObject(["\n      INSERT INTO convocation (id_player, id_match, status)\n      VALUES (", ", ", ", 'Waiting')\n    "], ["\n      INSERT INTO convocation (id_player, id_match, status)\n      VALUES (", ", ", ", 'Waiting')\n    "])), player.id_player, match.id_match)];
                    case 4:
                        _e.sent();
                        _e.label = 5;
                    case 5:
    ...
    Repository.prototype.getMatchById = function (id_match) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Repository.prototype.statisticsplayer = function (id_player) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sql(templateObject_50 || (templateObject_50 = __makeTemplateObject(["\n      SELECT goals, passes, yellow_cards, red_cards\n      FROM statistics\n      WHERE id_player = ", "\n    "], ["\n      SELECT goals, passes, yellow_cards, red_cards\n      FROM statistics\n      WHERE id_player = ", "\n    "])), id_player)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result[0] || null];
                }
    ...
    Repository.prototype.nextTraining = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
